...
namespace Kampus.Migrations
{
    ...
    [Migration("20240706214346_add discriminator for posts quote and reply")]
    partial class adddiscriminatorforpostsquoteandreply
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kampus.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Kampus.Grades.Grade", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Kampus.PostsLikes.PostLike", b =>
                {
                    ...
                    b.ToTable("AppPostLikes", (string)null);
                });

            modelBuilder.Entity("Kampus.Universities.University", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppUniversities", (string)null);
                });

            modelBuilder.Entity("Kampus.UserBlocks.UserBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBlockedUsers", (string)null);
                });

            modelBuilder.Entity("Kampus.UserFollows.UserFollow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Kampus.UserFriendRequests.UserFriendRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppUserFriendRequests", (string)null);
                });

            modelBuilder.Entity("Kampus.UserFriends.UserFriend", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppUserFriends", (string)null);
                });

            modelBuilder.Entity("Kampus.UserSettings.UserSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Kampus.PostQuotes.PostQuote", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("PostQuote");
                });
            ...
            modelBuilder.Entity("Kampus.PostReplies.PostReply", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("PostReply");
                });
            ...
            modelBuilder.Entity("Kampus.UserBlocks.UserBlock", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "BlockedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Kampus.UserFollows.UserFollow", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "Followee")
                        .WithMany()
            ...
            modelBuilder.Entity("Kampus.UserFriendRequests.UserFriendRequest", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("Kampus.UserFriends.UserFriend", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "FriendUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Kampus.UserSettings.UserSetting", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("Kampus.UserSettings.UserSetting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
